"""reunited_27382 URL Configuration
...
admin.site.site_header = "REUNITED"
admin.site.site_title = "REUNITED Admin Portal"
admin.site.index_title = "REUNITED Admin"

# swagger
api_info = openapi.Info(
    title="REUNITED API",
    default_version="v1",
    description="API documentation for REUNITED App",
)
